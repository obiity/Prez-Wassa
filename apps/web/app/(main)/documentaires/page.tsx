      ...
      <main className="min-h-screen bg-background relative flex flex-col">
        ...
        <div className="pt-32 pb-16 px-6 md:px-12 max-w-[1600px] mx-auto w-full flex-shrink-0">
          <div className="mb-12">
            ...
            <h1 className="text-4xl md:text-6xl font-serif font-bold text-brand-primary mb-2">Documentaires</h1>
            <p className="text-sm md:text-base text-brand-primary font-serif italic tracking-wide mb-4">
              Exploration poignante du réel, des récits de terrain et portraits intimes
            </p>
            <p className="text-xl text-muted font-sans font-light max-w-2xl">
              Le cinéma du réel sénégalais et africain. Explorez des récits poignants, des enquêtes de terrain et des portraits intimistes ancrés dans les réalités du continent.
            </p>
          </div>
        </div>
          ...
          <div className="flex-1 relative flex items-center justify-center p-6 border-t border-white/5 bg-secondary/30 overflow-hidden">
            ...
            >
              <h2 className="text-3xl md:text-5xl font-serif font-bold text-foreground mb-6 leading-tight">
                Bientôt <span className="italic text-muted font-light">disponible.</span>
              </h2>
              ...
              <p className="text-lg md:text-xl font-sans text-muted font-light leading-relaxed">
                Nous préparons une sélection exclusive de documentaires pour vous offrir un regard authentique sur l'Afrique d'hier, d'aujourd'hui et de demain. À suivre très prochainement.
              </p>
            </motion.div>
          </div>
        ) : (
